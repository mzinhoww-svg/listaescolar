...
export default function ListError({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <Screen>
      <div className="flex flex-1 flex-col gap-3.5" role="alert">
        ...
        <h1 className="text-[28px] leading-[1.1] font-extrabold tracking-[-0.035em]">Não conseguimos abrir a lista agora</h1>
        <p className="text-texto-2 text-[15px] leading-[1.4] font-medium">
          Houve um problema ao consultar esta lista. Tente de novo em instantes.
        </p>
        <div className="flex-1" />
