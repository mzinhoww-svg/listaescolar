...
/** INEP inexistente e município não habilitado são indistinguíveis. */
    ...
    <Screen>
      <div className="flex flex-1 flex-col gap-3.5">
        ...
        <p className="text-texto-2 text-[15px] leading-[1.4] font-medium">
          Não há uma escola com este INEP disponível no ListaCerta. Confira o número ou busque pelo nome.
        </p>
        <div className="flex-1" />
