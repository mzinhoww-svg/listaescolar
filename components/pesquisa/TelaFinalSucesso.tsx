  ...
  return (
    ...
    >
      ...
      <div className="bg-tinta text-papel rounded-card flex flex-1 flex-col items-center justify-center gap-5 px-6 py-12 text-center shadow-[0_16px_40px_rgba(15,27,45,0.22)]">
        ...
        <TituloTela focar>Pronto! Ajude outra mãe a economizar tempo.</TituloTela>
      </div>
      <a
        href={href}
        target="_blank"
        rel="noopener noreferrer"
        className="bg-verde-fundo focus-visible:outline-verde-fundo rounded-botao flex h-14 w-full items-center justify-center gap-2.5 text-base font-extrabold text-white shadow-[0_8px_24px_rgba(11,107,74,0.28)] transition-[transform,filter] duration-150 hover:brightness-110 focus-visible:outline-2 focus-visible:outline-offset-2 active:scale-[0.99]"
      >
