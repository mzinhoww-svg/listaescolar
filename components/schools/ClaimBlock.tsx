...
function Card({ state, eyebrow, tag, title, text, children }: { state: string; eyebrow: string; tag: string; title: string; text: string; children?: React.ReactNode }) {
  return (
...
/**
 * Bloco de ação do perfil (App14b), pelo estado real: 1 sem admin, 2 com admin (sem botão),
