...
vi.mock("next/navigation", () => ({ useRouter: () => ({ replace: routerReplace, refresh: vi.fn() }) }));
...
describe("GradeYearPicker", () => {
  ...
  it("com lista publicada mostra versão, itens e o link para a página da lista", () => {
    render(<GradeYearPicker inep="51001234" serie="ef-4" ano={2027} years={[2026, 2027]} published={{ versionNumber: 2, itemCount: 12 }} />);
    ...
    expect(screen.getByRole("link", { name: "Ver lista" })).toHaveAttribute("href", "/escolas/51001234/ef-4?ano=2027");
  });
